...
--insert into bps_78000.t_dktj_unbound_customer(xd_customer_no, account_no, account_open_date, customer_name, start_date, org_code, identity_type, identity_no, customer_type, date, create_time, flag) VALUES ('0008899085','780030110000000026578','2026-03-30','王五', '2026-03-30','78003','1','150127884513325','1','2026-03-30',now(),'1');
...
-- 员工贷款任务分成表
DROP TABLE IF EXISTS bps_78000.t_dktj_employee_customer_task_detail;
CREATE TABLE bps_78000.t_dktj_employee_customer_task_detail (
   emp_cst_id bigint,
...
COMMENT ON COLUMN bps_78000.t_dktj_employee_customer_task_detail.emp_cst_id IS 'employee_customer的id';
COMMENT ON COLUMN bps_78000.t_dktj_employee_customer_task_detail.teller_code IS '员工编号';
COMMENT ON COLUMN bps_78000.t_dktj_employee_customer_task_detail.percentage IS '分成比例';
COMMENT ON COLUMN bps_78000.t_dktj_employee_customer_task_detail.create_time IS '创建时间';
COMMENT ON COLUMN bps_78000.t_dktj_employee_customer_task_detail.create_by IS '创建人';
