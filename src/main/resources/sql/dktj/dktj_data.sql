...
INSERT INTO bps_78000.t_sys_menu(id, parent_id, parent_ids, name, sort, type, uri, target, icon, is_show, permission, description, remarks, create_by, create_time, update_by, update_time, del_flag) VALUES(522, 515, '{0,1,500,515}', '机构日均', 522, 'MENU_TYPE_MENU_MENU', '/dktj/loan/orgAverage', 'dktjloanorgavg', 'x-fa fa-comments', '1', 'dktj:loan:orgaverage', null, null, 1, now(), 1, now(), false);
...
INSERT INTO bps_78000.t_sys_menu(id, parent_id, parent_ids, name, sort, type, uri, target, icon, is_show, permission, description, remarks, create_by, create_time, update_by, update_time, del_flag) VALUES(527, 500, '{0,1,500}', '利息分成信息', 527, 'MENU_TYPE_MENU_GROUP', '', '', 'x-fa fa-comments', '1', '', null, null, 1, now(), 1, now(), false);
...
INSERT INTO bps_78000.t_sys_menu(id, parent_id, parent_ids, name, sort, type, uri, target, icon, is_show, permission, description, remarks, create_by, create_time, update_by, update_time, del_flag) VALUES(538, 535, '{0,1,500,535}', '变更复核', 538, 'MENU_TYPE_MENU_MENU', '/dktj/employeeinterest/positiontellerchecklist', 'dktjpositiontelleraltercheck', 'x-fa fa-comments', '1', 'dktj:employeeinterest:positiontellerchecklist', null, null, 1, now(), 1, now(), false);
...
insert into bps_78000.t_sys_api (id, name,uri,permission,remarks,create_by,create_time,update_by,update_time) values(229,'获取账号对应的模板列表 ','/dktj/template/getaccounttemplatelist','dktj:template:getaccounttemplatelist','手工写入权限',1,now(),1,now());
...
insert into bps_78000.t_sys_api (id, name,uri,permission,remarks,create_by,create_time,update_by,update_time) values(235,'获取贷款利息分成明细 ','/dktj/employeeinterest/get','dktj:employeeinterest:get','手工写入权限',1,now(),1,now());
insert into bps_78000.t_sys_api (id, name,uri,permission,remarks,create_by,create_time,update_by,update_time) values(236,'获取已变更但未复核的岗位责任人列表 ','/dktj/employeeinterest/positiontellerchecklist','dktj:employeeinterest:positiontellerchecklist','手工写入权限',1,now(),1,now());
insert into bps_78000.t_sys_api (id, name,uri,permission,remarks,create_by,create_time,update_by,update_time) values(237,'复核通过岗位责任人变更申请','/dktj/employeeinterest/positiontellercheck','dktj:employeeinterest:positiontellercheck','手工写入权限',1,now(),1,now());
insert into bps_78000.t_sys_api (id, name,uri,permission,remarks,create_by,create_time,update_by,update_time) values(238,'复核拒绝岗位责任人变更申请','/dktj/employeeinterest/positiontelleruncheck','dktj:employeeinterest:positiontelleruncheck','手工写入权限',1,now(),1,now());
...
insert into bps_78000.t_sys_role_permission(role_id, api_id, data_scope, create_time, create_by ) VALUES (1, 235, 'DATA_SCOPE_ORGANIZATION_AND_CHILD', now(), 1);
insert into bps_78000.t_sys_role_permission(role_id, api_id, data_scope, create_time, create_by ) VALUES (1, 236, 'DATA_SCOPE_ORGANIZATION_AND_CHILD', now(), 1);
insert into bps_78000.t_sys_role_permission(role_id, api_id, data_scope, create_time, create_by ) VALUES (1, 237, 'DATA_SCOPE_ALL', now(), 1);
insert into bps_78000.t_sys_role_permission(role_id, api_id, data_scope, create_time, create_by ) VALUES (1, 238, 'DATA_SCOPE_ALL', now(), 1);
